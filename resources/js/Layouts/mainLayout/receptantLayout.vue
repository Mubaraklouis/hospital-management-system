...
// import DashBoard from "./components/dashBoard.vue";
// import inProductTable from './components/inProductTable.vue';
</script>
    ...
    <div>
        <section class="grid h-full grid-cols-5">
                    ...
                    <div class="mt-36">
                        <ul class="flex flex-col gap-5 text-xs font-extrabold text-bold">
                            ...
                            <li class="flex items-center gap-y-6 gap-x-2">
                               ...
                               <Link href="/receptant/home">Reception</Link>
                            </li>
                            <li class="flex items-center gap-y-6 gap-x-2">
                                <div>
                                    <img class="w-4 h-4" src="/icons/doctor.png" alt="" />
                                </div>
                                <Link href="/patients/index">Patients</Link>
                            </li>
            ...
            <div class="col-span-4">
                ...
                <Link href="/receptant/home">Receptant</Link>
                    </h4>
                </div>
               ...
               calender dropdown -->
                <div class="flex pl-12 m-8 filters-inputs gap-x-8">
                    ...
                    <input
                        class="grid items-center justify-center grid-cols-3 gap-2 pl-4 text-xs calender-input"
